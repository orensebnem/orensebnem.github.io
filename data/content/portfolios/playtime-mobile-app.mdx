...
<Components.Chakra.Image
    src={`${imagePath}playtime-feature-prioritisation.png`}
    alt='Playtime Feature Prioritisation'
/>
...
<Components.Chakra.Image
    src={`${imagePath}playtime-roadmap.png`}
    alt='Playtime Roadmap'
/>
